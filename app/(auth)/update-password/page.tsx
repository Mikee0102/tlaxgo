        ...
        <div className="grid w-full overflow-hidden rounded-[2rem] border border-slate-800/80 bg-slate-900/80 shadow-2xl shadow-sky-950/30 backdrop-blur-xl md:grid-cols-[1.1fr_0.9fr]">
          <section className="relative hidden bg-slate-950/70 p-10 md:flex md:flex-col md:justify-between">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-black leading-tight text-white">
                Actualiza tu contraseña y continúa tu aventura.
              </h1>
              <p className="max-w-md text-base text-slate-300">
                Elige una contraseña segura para mantener protegida tu cuenta y seguir explorando Tlaxcala con confianza.
              </p>
            </div>
            ...
            <div className="grid gap-3 text-sm text-slate-200">
              {[
                ...
                "Sigue planificando rutas y lugares favoritos",
              ].map((item) => (
          ...
          <section className="p-6 sm:p-8 lg:p-10">
            <div className="mb-8 flex items-center justify-between gap-3">
              <div>
                <p className="text-sm uppercase tracking-[0.25em] text-sky-300">Cuenta</p>
                <h2 className="mt-2 text-3xl font-black text-white">Nueva contraseña</h2>
              </div>
